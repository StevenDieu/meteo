...
public class DayFragment extends Fragment {
    ...
    private IIformationWeatherData callApiToInjectDailtyInformationWeather(final WeatherFormServer weather, final ArrayList<Map<String, String>> informationWeatherList, final long dateCallApi) {
        ...
        DatabaseManagerInformationWeatherDailyData.getInstance(mContext).addInformationWeatherDailyData(informationWeatherDailyData);
        return informationWeatherDailyData;
    }
    ...
    private IIformationWeatherData callApiToInjectCurrentInformationWeather(final WeatherFormServer weather, final ArrayList<Map<String, String>> informationWeatherList) {
        ...
        final DatabaseManagerInformationWeatherCurrentData databaseManagerInformationWeatherCurrentData = DatabaseManagerInformationWeatherCurrentData.getInstance(mContext);

        insertInformationWeatherCurrentlyToList(informationWeatherCurrentData, informationWeatherList);
        databaseManagerInformationWeatherCurrentData.deleteAllInformationWeatherCurrentData();
        databaseManagerInformationWeatherCurrentData.addInformationWeatherCurrentData(informationWeatherCurrentData);
        return informationWeatherCurrentData;
    }
    ...
    private void callBddToInjectCurrentInformationWeather() {
        final DatabaseManagerInformationWeatherCurrentData dManagerCurrent = DatabaseManagerInformationWeatherCurrentData.getInstance(mContext);
    ...
    private void callBddToInjectDailyInformationWeather() {
        final DatabaseManagerInformationWeatherDailyData dManagerDaily = DatabaseManagerInformationWeatherDailyData.getInstance(mContext);
